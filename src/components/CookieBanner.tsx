...
const CookieBanner = () => {
  ...
  return (
    <div id="cookie-banner" className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-foreground/95 backdrop-blur-sm border-t border-border shadow-lg animate-in slide-in-from-bottom duration-300">
